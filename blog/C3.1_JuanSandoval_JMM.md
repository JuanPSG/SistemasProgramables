...
3. Explique el resultado observado.     
        ...
        Al realizar el circuito y ya ejecutado me percaté que el led enciende por un cierto tiempo y se vuelve apagar y así sucesivamente.  Todo esto por que se manda corriente del puerto GND al led , y la señal para realizar esa acción por el puerto 13. 



4. Inserte aquí las imágenes que considere como evidencias para demostrar el resultado obtenido.    
5. <p align="center">
    <img alt="Practica realizada" src="../img/C3.1Arduino.png" width=600 height=400>
</p>
