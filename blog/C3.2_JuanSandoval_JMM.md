...
3. Inserte imágenes que considere como evidencias para demostrar el resultado obtenido. 
    ...
    **Análisis:**       
    ```
    El puerto 9600 guarda y reporta cada vez que presionamos el botón, cuando se presiona provoca que su estado cambie de 0 a 1 , y volverá a 0 cuando se deje de presionar. 
     ```
<p align="center">
    <img alt="Circuito" src="../img/C3.2_CircuitoA.png" width=500 height=400>
</p>    
